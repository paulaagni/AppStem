...
val info = listOf(
    ...
    DataScroll(R.string.cecilia_payne, R.string.astronoma, R.drawable.ceciliapayne),
    ...
    DataScroll(R.string.annie_easley, R.string.informatica, R.drawable.annieeasley),
